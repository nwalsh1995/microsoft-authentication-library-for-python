...
class AsyncBaseClient(object):
    ...
    def __init__(
        ...
        self.session = httpx.AsyncClient(verify=verify, proxies=proxies, timeout=timeout,
    ...
    async def _obtain_token(  # The verb "obtain" is influenced by OAUTH2 RFC 6749
        ...
        resp = await self.send_obtain_token(headers=_headers, params=params, data=_data,
    ...
    async def send_obtain_token(self, headers, params, data, auth, timeout, post, **kwargs):
        return await (post or self.session.post)(
...
class AsyncClient(AsyncBaseClient):  # We choose to implement all 4 grants in 1 class
    ...
    async def send_dae_request(self, data, timeout, **kwargs):
        return await self.session.post(self.configuration[DAE],
                                       data=data,
                                       timeout=timeout,
                                       **kwargs)
    ...
    async def _obtain_token(self, grant_type, params=None, data=None, *args, **kwargs):
        RT = "refresh_token"
